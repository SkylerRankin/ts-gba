const IO_REGISTERS = {
    ...
    TM0CNT_L:   [ 0x04000100, 2 ],
    TM0CNT_H:   [ 0x04000102, 2 ],
    TM1CNT_L:   [ 0x04000104, 2 ],
    TM1CNT_H:   [ 0x04000106, 2 ],
    TM2CNT_L:   [ 0x04000108, 2 ],
    TM2CNT_H:   [ 0x0400010A, 2 ],
    TM3CNT_L:   [ 0x0400010C, 2 ],
    TM3CNT_H:   [ 0x0400010E, 2 ],
